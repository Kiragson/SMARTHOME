...
<body>
<div class="row justify-content-center h-max">
<h3>Formularz Logowania</h3>
</div>
<div class="row justify-content-center h-max">
    <div class="col-12 navbar-light p-5 rounded h-100" style="background-color: #e3f2fd;">
        <form method="post" action="http://localhost/studia/SMARTHOME/php_script_mobile/logowanie.php" id="login-form">
            <div class="mb-3">
